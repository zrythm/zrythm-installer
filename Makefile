...
installer: artifacts
	...
	cp artifacts/fedora31/$(FEDORA31_PKG_FILE) \
		bin/fedora/zrythm-$(ZRYTHM_VERSION)-1_31_x86_64.deb
...
# for each distro
.PHONY: artifacts
artifacts: artifacts/debian10/$(DEBIAN_PKG_FILE) artifacts/ubuntu1904/$(DEBIAN_PKG_FILE) artifacts/arch/$(ARCH_PKG_FILE) artifacts/fedora31/$(FEDORA31_PKG_FILE)
